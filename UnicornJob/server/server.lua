...
RegisterNetEvent('bar:BuyBiere')
AddEventHandler('bar:BuyBiere', function()
...
RegisterNetEvent('bar:BuyCocktail')
AddEventHandler('bar:BuyCocktail', function()
...
RegisterNetEvent('bar:BuyCurly')
AddEventHandler('bar:BuyCurly', function()
    ...
    if xMoney >= price then
        ...
        xPlayer.removeMoney(price)
        xPlayer.addInventoryItem('curly', 1)
        TriggerClientEvent('esx:showNotification', source, "~g~Achats~w~ effectué !")
    else
         TriggerClientEvent('esx:showNotification', source, "Vous n'avez assez ~r~d\'argent")
    end
...
RegisterNetEvent('bar:BuyChips')
AddEventHandler('bar:BuyChips', function()
